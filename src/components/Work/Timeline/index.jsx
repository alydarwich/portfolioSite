...
const Timeline = () => {
    const [events, setEvents] = useState([
        {
            date: "July 1st 2024 - August 30th 2024",
            title: "Touch Telecom",
            description: [
                "test test test (test test test), test test <b>test</b> test <b>test</b> test, test test test <b>test test</b> test test test test, test test test test test <b>37%</b>",
                "test test 1200+ <b>test test</b> test test test <b>test</b> (test test), <b>test</b>, test <b>test</b> test <b>test</b>, test test test $20,000 test test test test test test test test test test test test test test test",
                "test <b>test</b> test test test test test test <b>test test</b>, test test test, test test test test test test test test, test test test test <b>test</b> test test test test <b>test</b> test test",
            ],
            expanded: false,
        },
        {
